...
public:
	...
	static int		   CaselessCompare(const char* pLhs, const char* pRhs) { return strcmp(pLhs, pRhs); }
...
inline bool UtlStringCaseInsensitiveLessFunc(const CUtlString& lhs, const CUtlString& rhs) { return _stricmp(lhs.Get(), rhs.Get()) < 0; }
