...
public:
	...
	virtual CVector const& GetRenderAngles(void) = 0;
	...
	virtual void	GetShadowRenderBounds(CVector& mins, CVector& maxs, ShadowType_t shadowType) = 0;
	virtual bool	ShouldReceiveProjectedTextures(int flags) = 0;
	virtual bool	GetShadowCastDistance(float* pDist, ShadowType_t shadowType) const = 0;
	virtual bool	GetShadowCastDirection(CVector* pDirection, ShadowType_t shadowType) const = 0;
	...
	virtual	bool GetAttachment(int number, CVector& origin, CVector& angles) = 0;
